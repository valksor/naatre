...
func TestSpecificationIndexLinksEveryNormativeDocument(t *testing.T) {
	...
	for _, name := range []string{"core.md", "protocol.md", "schema.md", "language.md", "canonicalization.md", "security.md", "http.md", "persisted.md", "collections.md", "mutations.md", "reliability.md", "federation.md"} {
