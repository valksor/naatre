...
| PHP, `naatre/sdk` | [`sdk.php.core-1`](../../conformance/v1/php-sdk.json): [request/result test](../../sdk/php/tests/run.php), run `composer --working-dir=sdk/php check` | PHP 8.3, 8.4, and 8.5; ubuntu-24.04 CI | [`sdk.php.server-1`](../../conformance/v1/php-server.json): [stdio example](../../examples/v1/workers/php.php) | Not established |
