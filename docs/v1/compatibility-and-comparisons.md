...
| Python | Implemented core and adapters | Executable conformance worker example; ASGI/native worker certification is separate | Planned | Only listed CPython/profile commands and reports are tested. |
